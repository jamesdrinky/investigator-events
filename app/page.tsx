        ...
        <div className="container-shell relative">
          <Reveal className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 max-w-[12ch] text-4xl font-semibold leading-[0.94] tracking-[-0.05em] text-slate-950 sm:text-5xl lg:text-[4.2rem]">
                Featured event surfaces with real editorial weight.
              </h2>
            </div>
                  ...
                  <div className="relative grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-end">
                    <div className="flex h-full flex-col justify-between">
                      <div>
                        ...
                        <h3 className="mt-6 max-w-[11ch] text-4xl font-semibold leading-[0.93] tracking-[-0.05em] text-slate-950 sm:text-5xl">
                          {leadEvent.title}
                        </h3>
                    ...
                    <article className="group relative overflow-hidden rounded-[2.4rem] border border-white/80 bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(247,250,255,0.92))] p-5 shadow-[0_34px_96px_-56px_rgba(15,23,42,0.18)] transition duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1.5 hover:shadow-[0_54px_126px_-62px_rgba(76,90,255,0.28)] sm:p-6">
                      ...
                      <div className="relative grid gap-5 sm:grid-cols-[10.5rem_minmax(0,1fr)] sm:items-center">
                        <EventCoverMedia
                          ...
                          featured
                          compact
                          className="h-[12rem] sm:h-[11.5rem]"
                        />
                        <div>
        ...
        <div className="container-shell relative">
          <Reveal className="grid gap-10 xl:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] xl:items-end">
            <div className="max-w-xl">
              ...
              <h2 className="mt-4 max-w-[12ch] text-4xl font-semibold leading-[0.94] tracking-[-0.05em] text-slate-950 sm:text-5xl lg:text-[4rem]">
                Credibility from the network behind the calendar.
              </h2>
              <p className="mt-6 text-base leading-relaxed text-slate-600">
                Associations are visible as brands, not buried metadata. The homepage keeps that network present without crowding the experience.
              </p>
                  ...
                  <div className="mt-6 grid gap-6 rounded-[2rem] border border-white/90 bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(247,250,255,0.92))] p-6 shadow-[0_26px_70px_-42px_rgba(15,23,42,0.16)] lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] lg:items-center">
                    ...
                    <div>
                      ...
                      <p className="mt-3 text-sm leading-relaxed text-slate-600">
                        Strong visibility in the calendar with {featuredAssociation.eventCount} linked events across {featuredAssociation.countryCount} countries.
                      </p>
                      <div className="mt-5 flex flex-wrap gap-3">
                        <Link
