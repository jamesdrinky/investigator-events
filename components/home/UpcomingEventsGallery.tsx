        ...
        <Reveal>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-semibold leading-[0.94] tracking-[-0.05em] text-slate-950 sm:mt-3 sm:text-5xl lg:text-[4rem]">
                Next on the calendar
              </h2>
            </div>
            <Link
              href="/calendar"
              className="btn-secondary hidden px-5 py-3 sm:inline-flex sm:w-auto sm:px-6 sm:py-3"
            >
              View full calendar
            </Link>
          </div>
