...
import { BellRing, CalendarCheck, MessageSquareQuote, RefreshCw, Users } from 'lucide-react';
      ...
      <section className="relative overflow-hidden rounded-3xl bg-[#050b1b] px-6 py-14 text-center sm:px-12 sm:py-16">
        ...
        <div className="relative">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-slate-300">
            {upcoming > 0 ? (
              <>
                We already track <b className="text-white">{upcoming} upcoming {assoc.shortName} {upcoming === 1 ? 'event' : 'events'}</b> —
      ...
      <section className="mx-auto mt-16 max-w-3xl">
        <div className="mb-6 text-center">
          ...
          <p className="mx-auto mt-2 max-w-lg text-sm leading-relaxed text-slate-500">
            Everything below is live from the Investigator Events calendar — pick your colour and watch it become
            yours. What you see is exactly what your members would see.
          </p>
        </div>
        <PartnerLiveDemo shortName={assoc.shortName} fakeDomain={fakeDomain} embedFilter={embedFilter} />
      </section>
