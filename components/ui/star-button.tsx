...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 z-[4] overflow-hidden rounded-[inherit] border-slate-200/60 text-slate-600"
        style={{ borderWidth: "var(--border-width)" }}
        aria-hidden="true"
      >
        <StarBackground color={backgroundColor} />
      </div>
      <span className="z-10 relative bg-gradient-to-t from-slate-900 to-slate-500 inline-block text-transparent bg-clip-text font-semibold">
        {children}
      </span>
    </button>
  );
