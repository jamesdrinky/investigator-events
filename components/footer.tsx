...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f5f9ff_100%)]">
      ...
      <div className="container-shell relative grid gap-10 py-14 md:grid-cols-[1.2fr_0.8fr_0.8fr_0.9fr] lg:py-16">
        <div>
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#1668ff,#14b8ff,#645bff)] text-sm font-semibold text-white shadow-[0_18px_36px_-22px_rgba(22,104,255,0.42)]">
            IE
          </div>
          <p className="mt-5 text-[11px] font-semibold tracking-[0.28em] text-slate-900">INVESTIGATOR EVENTS</p>
          <p className="mt-4 max-w-md font-[var(--font-serif)] text-3xl leading-tight text-slate-950">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm text-slate-600">
            <li><Link href="/calendar" className="hover:text-slate-950">Calendar</Link></li>
            <li><Link href="/associations" className="hover:text-slate-950">Associations</Link></li>
            <li><Link href="/weekly" className="hover:text-slate-950">Weekly</Link></li>
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm text-slate-600">
            <li><Link href="/submit-event" className="hover:text-slate-950">Submit event</Link></li>
            <li><Link href="/advertise" className="hover:text-slate-950">Promote an event</Link></li>
            <li><Link href="/#newsletter" className="hover:text-slate-950">Newsletter</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="mt-6 rounded-[1.4rem] border border-slate-200 bg-white/80 p-4 shadow-[0_18px_36px_-30px_rgba(15,23,42,0.16)]">
      ...
      <div className="border-t border-slate-200 py-4 text-center text-xs text-slate-500">
        © {new Date().getFullYear()} Investigator Events
      </div>
    </footer>
  );
}
