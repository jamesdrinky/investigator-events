...
export function FinalConversionCTA({ countriesCount }: FinalConversionCTAProps) {
  return (
      ...
      <div className="container-shell relative">
        <div className="mx-auto max-w-2xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 backdrop-blur-sm">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.22em] text-white/80">Join the community</span>
          </div>
          ...
          <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-white/70 sm:text-lg">
            Create your profile in 2 minutes. Browse events. Verify membership. Connect with peers across {countriesCount} countries.
          </p>

          <div className="mt-7 flex flex-col items-stretch gap-3 sm:mt-10 sm:flex-row sm:items-center sm:justify-center sm:gap-4">
            <Link
              href="/signup"
