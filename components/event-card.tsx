  ...
  const cardContent = (
    <>
      ...
      <div className="relative">
        <h3 className="text-[1.65rem] font-semibold leading-[1.02] text-slate-950 transition-colors duration-300 group-hover:text-blue-700">
          {event.title}
        </h3>
      ...
      <div className="relative flex items-center justify-between gap-3 text-sm">
        ...
        <span className="rounded-full bg-[linear-gradient(135deg,#1668ff,#14b8ff,#645bff)] px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-white shadow-[0_14px_24px_-16px_rgba(22,104,255,0.42)]">
          Open event
        </span>
      </div>
    </>
