    ...
    <section className="relative overflow-hidden py-20 sm:py-28">
      ...
      <div className="container-shell relative">
        <div className="app-mobile-shell">
          <Reveal>
            <div className="mx-auto max-w-5xl overflow-hidden rounded-[1.6rem] border border-white/70 bg-white/95 p-7 shadow-[0_40px_100px_-40px_rgba(76,90,255,0.18)] sm:rounded-[2.5rem] sm:p-10 lg:p-14">
              {/* Glass highlight */}
              ...
              <div className="relative grid gap-5 sm:gap-8 lg:grid-cols-[5.5rem_minmax(0,1fr)] lg:items-start">
                ...
                <div>
                  ...
                  <blockquote className="mt-5 text-[1.35rem] font-semibold leading-[1.32] tracking-[-0.02em] text-slate-950 sm:mt-6 sm:text-[1.75rem] sm:leading-[1.35] lg:text-[2.15rem] lg:leading-[1.3]">
