...
export function Navbar() {
  ...
  return (
    <>
      <header ref={headerRef} data-mobile-header className={`fixed inset-x-0 top-0 z-[110] shrink-0 border-b backdrop-blur-md sm:backdrop-blur-xl lg:sticky ${isDark ? 'border-white/[0.06] bg-[#080f1e]/90' : 'border-slate-200/70 bg-white/92 sm:bg-white/88'}`} style={{ paddingTop: 'var(--safe-top, 0px)' }}>
            ...
            {user ? (
              <div ref={dropdownRef} className="relative flex items-center gap-2">
                ...
                <div ref={notifRef} className="relative">
                  ...
                  {showNotifs && (
                    <div className="fixed inset-x-0 z-[95] rounded-b-2xl border-b border-slate-200 bg-white shadow-2xl sm:absolute sm:inset-x-auto sm:right-0 sm:top-full sm:mt-2 sm:w-80 sm:rounded-xl sm:border" style={{ top: 'calc(3.25rem + var(--safe-top, 0px))' }}>
