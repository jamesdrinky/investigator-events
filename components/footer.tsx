...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-slate-800 bg-[#0f172a]">
      <div className="container-shell grid gap-10 py-14 md:grid-cols-[1.1fr_0.9fr_0.8fr]">
        <div className="relative">
          <p className="text-[11px] font-semibold tracking-[0.26em] text-blue-300">INVESTIGATOR EVENTS</p>
