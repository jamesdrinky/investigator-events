...
export const associationRecords: AssociationRecord[] = [
  ...
  },
  {
    slug: 'scali',
    shortName: 'SCALI',
    name: 'South Carolina Association of Legal Investigators',
    country: 'United States',
    region: 'North America',
    website: 'https://www.scalinv.com/',
    aliases: ['SCALI', 'South Carolina Association of Legal Investigators'],
  },
  {
    slug: 'mapi',
    shortName: 'MAPI',
    name: 'Minnesota Association of Private Investigators',
    country: 'United States',
    region: 'North America',
    website: 'https://mapi.org/',
    aliases: ['MAPI', 'Minnesota Association of Private Investigators'],
  },
  {
    slug: 'cajp',
    shortName: 'CAJP',
    name: 'California Association of Judgment Professionals',
    country: 'United States',
    region: 'North America',
    website: 'https://cajp.org/',
    aliases: ['CAJP', 'California Association of Judgment Professionals'],
  },
  {
    slug: 'scfia',
    shortName: 'SCFIA',
    name: 'Southern California Fraud Investigators Association',
    country: 'United States',
    region: 'North America',
    website: 'https://scfia.org/',
    aliases: ['SCFIA', 'Southern California Fraud Investigators Association'],
  },
  {
    slug: 'gappi',
    shortName: 'GAPPI',
    name: 'Georgia Association of Professional Private Investigators',
    country: 'United States',
    region: 'North America',
    website: 'https://www.gappi.org/',
    aliases: ['GAPPI', 'Georgia Association of Professional Private Investigators'],
  },
  {
    slug: 'piai',
    shortName: 'PIAI',
    name: 'Private Investigators Association of Idaho',
    country: 'United States',
    region: 'North America',
    website: 'https://piai.us/',
    aliases: ['PIAI', 'Private Investigators Association of Idaho'],
  },
  {
    slug: 'pawli',
    shortName: 'PAWLI',
    name: 'Professional Association of Wisconsin Licensed Investigators',
    country: 'United States',
    region: 'North America',
    website: 'https://pawli.com/',
    aliases: ['PAWLI', 'Professional Association of Wisconsin Licensed Investigators'],
  },
  {
    slug: 'acfe',
    shortName: 'ACFE',
    ...
    aliases: ['ACFE', 'Association of Certified Fraud Examiners'],
  },
  {
    slug: 'oali',
    shortName: 'OALI',
    name: 'Oregon Association of Licensed Investigators',
    country: 'United States',
    region: 'North America',
