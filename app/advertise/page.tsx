  ...
  return (
    <section className="section-pad relative overflow-hidden">
      <div className="container-shell space-y-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.2rem] border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-end">
              ...
              <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                {reasons.map((reason) => (
                  <div key={reason} className="rounded-[1.4rem] border border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-700">
                    {reason}
                  </div>
                ))}
              </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
          <Reveal>
            <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-7">
              <div className="relative">
                ...
                <div className="mt-5 rounded-[1.4rem] border border-emerald-100 bg-emerald-50 p-4">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_1fr]">
          <div className="space-y-8">
            <Reveal>
              <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-7 shadow-sm sm:p-8">
              ...
              <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-7 shadow-sm sm:p-8">
                ...
                <div className="mt-5 space-y-3">
                  {placementOptions.map((option) => (
                    <article key={option.title} className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition hover:border-sky-200 hover:bg-sky-50/60">
