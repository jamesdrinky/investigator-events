  ...
  return (
    <div className="rounded-xl border border-slate-200/60 bg-white p-5">
      ...
      <p className="mt-1 text-sm text-slate-500">
        Sends a personalised email to every user. Variant chosen per user from their profile completion (3 tiers) and LinkedIn-verified state. Already-sent users are skipped — running again is safe.
      </p>
      ...
      {report && (
        <div className="mt-3 rounded-lg border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-800">
          ...
          <p className="mt-1">
            Considered {report.totals.considered} · Sent {report.totals.sent} · Already had it {report.totals.skippedAlreadySent} · No email {report.totals.skippedNoEmail} · Failed {report.totals.failed}
          </p>
