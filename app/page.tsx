  ...
  return (
    <>
      ...
      <section className="section-pad relative overflow-hidden pt-0">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_8%_18%,rgba(54,168,255,0.1),transparent_18%),radial-gradient(circle_at_88%_26%,rgba(255,104,203,0.08),transparent_18%)]" />
        <SectionStage className="container-shell">
          <Reveal className="mb-10 flex items-end justify-between gap-4">
            <div>
              <p className="eyebrow">Featured Events</p>
              <h2 className="section-title">Featured conferences, destination meetings, and major live signals</h2>
              <p className="section-copy max-w-2xl">
                Start with the headline events currently shaping the network, then move into the full calendar by country,
                city, region, and category.
              </p>
            </div>
            <Link href="/calendar" className="text-sm text-slate-300 hover:text-signal2">
              View Full Calendar
            </Link>
          </Reveal>
                ...
                {regionalSignals.length > 0 ? (
                  <div className="flex flex-wrap gap-2.5">
                    {regionalSignals.map((signal) => (
                      <article
                        key={signal.name}
                        className="min-w-[11rem] flex-1 rounded-full border border-white/10 bg-white/[0.03] px-4 py-3"
                      >
      ...
      <section className="section-pad relative overflow-hidden pt-2">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_16%_28%,rgba(29,214,202,0.08),transparent_18%),radial-gradient(circle_at_78%_18%,rgba(108,99,255,0.08),transparent_18%)]" />
        <SectionStage className="container-shell">
          <Reveal>
            <div className="global-panel relative overflow-hidden p-8 sm:p-10">
              ...
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_16%,rgba(54,168,255,0.12),transparent_24%),radial-gradient(circle_at_84%_22%,rgba(255,104,203,0.08),transparent_20%)]" />
              <div className="relative grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                ...
                <div className="grid gap-4">
                  <article className="rounded-[1.4rem] border border-white/12 bg-[linear-gradient(180deg,rgba(77,163,255,0.14),rgba(255,255,255,0.03))] px-5 py-5">
                    <p className="text-xs uppercase tracking-[0.18em] text-accent">1. Submit details</p>
                  ...
                  <article className="rounded-[1.4rem] border border-white/12 bg-[linear-gradient(180deg,rgba(77,163,255,0.08),rgba(255,255,255,0.03),rgba(52,211,153,0.08))] px-5 py-5">
                    <p className="text-xs uppercase tracking-[0.18em] text-accent">2. Review</p>
                    <p className="mt-2 text-sm text-slate-200">Submissions stay private until they are checked and approved.</p>
                  </article>
                  <article className="rounded-[1.4rem] border border-white/12 bg-[linear-gradient(180deg,rgba(52,211,153,0.14),rgba(255,255,255,0.025))] px-5 py-5">
                    <p className="text-xs uppercase tracking-[0.18em] text-accent">3. Publication</p>
